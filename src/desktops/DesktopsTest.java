...
public class DesktopsTest extends Utility {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder(){
            ...
            mouseHoverToElementAndClick(By.linkText("Desktops"),"Desktops");
//      1.2 Click on “Show All Desktops”
            clickOnElement(By.xpath("//a[contains(text(),'Show AllDesktops')]"));
//      1.3 Select Sort By position "Name: Z to A"
            selectByVisibleTextFromDropDown(By.cssSelector("#input-sort"), "Name (Z - A)");
//      1.4 Verify the Product will arrange in Descending order.
        verifyFromElement(By.xpath("//body/div[@id='product-category']/div[1]/div[1]/div[4]"),"Page displayed" );
    }
