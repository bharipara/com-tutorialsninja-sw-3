...
//3.3 Enter First Name
        sendTextToElement(By.name("firstname"), "Gabby");
//3.4 Enter Last Name
        sendTextToElement(By.name("lastname"), "Soni");
//3.5 Enter Email
        sendTextToElement(By.name("email"), "Gabs1232@gmail.com");
//3.6 Enter Telephone
        sendTextToElement(By.name("telephone"), "1234567890");
//3.7 Enter Password
        sendTextToElement(By.id("input-password"), "pqr123");
//3.8 Enter Password Confirm
        sendTextToElement(By.id("input-confirm"), "pqr123");
...
//4.3 Enter Email address
        sendTextToElement(By.id("input-email"), "Gabs1232@gmail.com");
//4.5 Enter Password
        sendTextToElement(By.name("password"), "pqr123");
