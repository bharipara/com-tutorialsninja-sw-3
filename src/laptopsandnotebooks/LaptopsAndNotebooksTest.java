...
public class LaptopsAndNotebooksTest extends Utility {
   ...
   @Test
    public void verifyProductsPriceDisplayHighToLowSuccessfully() {
        ...
        mouseHoverToElementAndClick(By.xpath("//body/div[1]/nav[1]/div[2]/ul[1]/li[2]/a[1]"),"Laptops & Notebooks");
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.xpath("//input[@id='input-payment-firstname']"), "Chan");
        sendTextToElement(By.xpath("//input[@id='input-payment-lastname']"), "Maan");
        sendTextToElement(By.xpath("//input[@id='input-payment-email']"), "Chan1234@gmail.com");
        sendTextToElement(By.xpath("//input[@id='input-payment-telephone']"), "1234567890");
        sendTextToElement(By.xpath("//input[@id='input-payment-address-1']"), "Wild street");
        sendTextToElement(By.xpath("//input[@id='input-payment-city']"), "Manchester");
        sendTextToElement(By.xpath("//input[@id='input-payment-postcode']"), "M123BC");
